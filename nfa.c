...
bool NFA_execute(NFA *nfa, char *input) {
    for(int i = 0; input[i] != '\0'; i++) {
        ...
        current_s_iterator = IntSet_iterator(nfa->current_states);
    ...
    final_s_iterator = IntSet_iterator(nfa->current_states); /*create another iterator for the set of last states*/
